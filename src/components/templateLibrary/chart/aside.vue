<template>
  <div class="chart-aside">
    <div class="aside-bar">
      <div class="bar-title" :class="{selected:selected === 'var' }" @click="selected = 'var'">Variable</div>
      <!--the reference list of helm chart not works in v1.6.0. please cancel the annotation when implement it-->
      <!--<div class="bar-title" :class="{selected:selected === 'quote' }" @click="selected = 'quote'">Citation List</div>-->
    </div>
