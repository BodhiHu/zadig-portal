    ...
    if (this.inProject) {
      bus.$emit(`set-topbar-title`, {
        ...
        breadcrumb: [
          ...
          { title: 'Version Management', url: `/v1/projects/detail/${this.projectName}/version` },
          { title: version, url: `` }
        ]
      })
    } else {
      bus.$emit(`set-topbar-title`, {
        title: '',
        breadcrumb: [
          { title: 'Delivery Center', url: `/v1/delivery/artifacts` },
          { title: 'Version Management', url: `/v1/delivery/version` },
          { title: version, url: `` }
        ]
      })
    }
