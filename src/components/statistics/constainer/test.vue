<template>
  <div class="auto-test">
    <span class="title">Automated Test</span>
      ...
      <el-row :gutter="10">
        <el-col class="number-block" :span="6">
          <div>
            ...
            <span class="desc">
              <i class="icon iconfont iconvery-testing"></i> Number Of Test Cases
            </span>
          </div>
        </el-col>
        <el-col class="number-block" :span="6">
          <div>
            ...
            <span class="desc">
              <i class="icon iconfont iconzhixing"></i> Number Of Executions
            </span>
          </div>
        </el-col>
        <el-col class="number-block" :span="6">
          <div>
            ...
            <h2 v-else>N/A</h2>
            <span class="desc">
              <i class="icon iconfont iconchenggong"></i> Success Rate
            </span>
          </div>
        </el-col>
        <el-col class="number-block" :span="6">
          <div>
            ...
            <span class="desc">
              <i class="icon iconfont iconhaoshi"></i> Average Time (s)
            </span>
          </div>
        </el-col>
      </el-row>
