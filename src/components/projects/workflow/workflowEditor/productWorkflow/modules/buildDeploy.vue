          ...
          <el-col :span="6">
            <div class="build-item build">
              <el-select
                ...
                :placeholder="!associatedBuilds[`${config.target.service_name}/${config.target.service_module}`] ? 'None' : 'Please Choose'"
              >
                <el-option
              ...
              <el-button type="text" @click="showBuildOpeDialog(config,_idx)">Set Up</el-button>
