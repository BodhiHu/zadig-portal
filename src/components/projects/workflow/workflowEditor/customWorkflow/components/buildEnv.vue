<template>
  <section>
    <div class="primary-title not-first-child">Execution Environment</div>
    <el-form ref="opeSystem" :model="opeConfig" label-position="left" class="primary-form" label-width="120px">
      ...
      >
        <el-select size="small" v-model="opeConfig.image_id" placeholder="Please Choose" @change="changeImage('id', $event)">
    ...
    <el-form ref="opeSystem" :model="installApp" label-position="left" class="primary-form" label-width="120px">
      <el-form-item v-if="installApp.installs.length===0" label="Dependent Packages" class="secondary-label">
      ...
      <el-form-item
        ...
        class="secondary-label"
      >
        <el-select v-model="installApp.installs[appIndex]" placeholder="Please Choose" size="small" value-key="id" filterable>
          <el-option
        ...
        <span class="app-operation">
          <el-button v-if="installApp.installs.length >= 1" @click="deleteApp(appIndex)" type="danger" size="mini" plain>Delete</el-button>
          <el-button v-if="appIndex===installApp.installs.length-1" @click="addApp(appIndex)" type="primary" size="mini" plain>New</el-button>
        </span>
      </el-form-item>
    </el-form>
  </section>
