<template>
  <div class="task-list-container">
    <el-table :data="taskList" stripe style="width: 100%;">
      ...
      <el-table-column min-width="100" prop="status" label="Task Status">
        <template slot-scope="scope">
          <span
      ...
      <el-table-column min-width="120" label="Duration">
        <template slot-scope="scope">
          ...
          <span v-else style="margin-left: 5px;">
            ...
            <el-tooltip v-if="durationSet[scope.row.task_id]<0" content="There may be inconsistencies between the local system time and the server，Please Sync。" placement="top">
