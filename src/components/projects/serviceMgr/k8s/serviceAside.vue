<template>
  <div class="aside__wrap">
    <el-drawer title="Code Source Integration" :visible.sync="integrationCodeDrawer" direction="rtl">
      <IntegrationCode @cancel="integrationCodeDrawer = false" />
    </el-drawer>
    <el-drawer title="Mirror repository integration" :visible.sync="registryCreateVisible">
      ...
      <div class="aside__content">
        <div v-if="selected === 'build'" class="service-aside--variables">
          <div style="padding-left: 15px;">
            <el-button @click="$router.back()" icon="el-icon-back" type="text">Return</el-button>
          </div>
          <header class="service-aside-box__header">
            <div class="service-aside-box__title">Construct</div>
          </header>
          ...
          <div class="service-aside-box__content">
            <section class="aside-section">
              ...
              <div v-if="allRegistry.length === 0" class="registry-alert">
                <el-alert type="warning">
                  <div>
                    Private image repositories are not integrated，
                    <el-button type="text" class="theme-color" style="padding: 0;" @click="registryCreateVisible = true">Integrate Now</el-button>
                  </div>
                </el-alert>
              </div>
              <el-table :data="serviceModules" stripe style="width: 100%;">
                ...
                <el-table-column prop="image">
                  <template slot="header">
                    <span>Current Image Version($IMAGE)</span>
                    <el-tooltip effect="dark" placement="top">
                      <div slot="content">
                        During workflow task execution，Generated By Build Tasks $IMAGE Mirror，The deployment task uses the generated $IMAGE Image Update Service。
                        <br />In $IMAGE Image name built into the system，Automatically generated when the workflow executes。
                        <br />Click「Strategy」Configure image name rules。
                      </div>
                      <span>
                        <i class="el-icon-question"></i>
                      </span>
                ...
                <el-table-column label="Build Info/Operate">
                  <template slot-scope="scope">
                    ...
                    <el-button size="small" v-hasPermi="{projectName: projectName, action: 'create_build',isBtn:true}" :disabled="projectName !== projectNameOfService" @click="addBuild(scope.row)" type="text">Add Build</el-button>
                  </template>
                </el-table-column>
              </el-table>
            </section>
            <section class="aside-section">
              <h4>
                ...
                <el-tooltip effect="dark" content="Use in service configuration $Namespace$，$Product$，$Service$，$EnvName$ Way Reference" placement="top">
                  <span>
                    <i class="el-icon-question"></i>
                  </span>
                </el-tooltip>
              ...
              <el-table :data="sysEnvs" stripe style="width: 100%;">
                ...
                <el-table-column prop="value" label="The Current Value">
                  <template slot-scope="scope">
            ...
            <section class="aside-section">
              <h4>
                ...
                </span> Global Variable
                <el-tooltip effect="dark" :content="'Global Variable Via'+' {{'+'.key}} ' +' Quote，All services in the project are available'" placement="top">
                  <span>
                    <i class="el-icon-question"></i>
                  </span>
                </el-tooltip>
              ...
              <div class="kv-container">
                <el-table :data="customEnvs" style="width: 100%;">
                  ...
                  <el-table-column v-hasPermi="{projectName: projectName, action: 'edit_service'}" label="Operate" width="150">
                    <template slot-scope="scope">
                      <span class="operate">
                        <el-button
                        ...
                        <el-tooltip
                          ...
                          effect="dark"
                          content="Used In The Service Key Cannot Be Deleted"
                          placement="top"
                        >
                    ...
                    <el-table-column width="150">
                      <template>
                        <span style="display: inline-block; margin-bottom: 15px;">
                          <el-button @click="addRenderKey()" type="text">Confirm</el-button>
                          <el-button @click="addKeyInputVisable=false" type="text">Cancel</el-button>
                        </span>
                      </template>
                    </el-table-column>
                  </el-table>
                ...
                <div v-hasPermi="{projectName: projectName, action: 'edit_service'}">
                  <el-button size="medium" class="add-kv-btn" @click="addKeyInputVisable=true" type="text">
                    <i class="el-icon-circle-plus-outline"></i>Add To
                  </el-button>
                </div>
              </div>
            </section>
  ...
  methods: {
    ...
    checkExistVars () {
      return new Promise((resolve, reject) => {
        ...
        if (isDuplicate) {
          this.$message({
            message: 'The same exists in the variable list Key Please Check And Save',
            type: 'warning'
          })
      ...
      updateEnvTemplateAPI(projectName, payload).then(res => {
        ...
        if (verbose) {
          this.$notify({
            ...
            message: 'Variable list saved successfully',
            type: 'success'
          })
        }
      })
    ...
    deleteRenderKey (index, state) {
      if (state === 'present') {
        this.$confirm('Should Key Referenced By Product，Confirm Delete', 'Hint', {
