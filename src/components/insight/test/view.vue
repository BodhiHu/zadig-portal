    ...
    <el-row class="row-container" :gutter="20">
        ...
        <div class="chart-wrapper">
          <div class="chart-container">
            <div class="chart-title">
              <span class="head">Test Trend</span>
      ...
      <el-col :span="8">
        <div class="chart-wrapper">
          <div class="chart-container">
            <div class="chart-title">
              <span class="head">Test Health</span>
              <span class="duration">{{getSetTime}}</span>
            </div>
      ...
      <el-col :span="8">
        <div class="chart-wrapper">
          <div class="chart-container">
            <div class="chart-title">
              <span class="head">Weekly Test Earnings（Number Of Executions x Number Of Test Cases）</span>
              <span class="duration">{{getSetTime}}</span>
            </div>
    ...
    <el-row class="row-container" :gutter="20">
      <el-col :span="8">
        <div class="chart-wrapper">
          <div class="chart-container">
            <div class="chart-title">
              <span class="head">Average Test Time</span>
              <span class="duration">{{getSetTime}}</span>
            </div>
      ...
      <el-col :span="8">
        <div class="chart-wrapper">
          <div class="chart-container">
            <div class="chart-title">
              <span class="head">Weekly delivery deployments</span>
